...
from mappings import board19_mapping, flipped_mapping, normal_board_mapping
...
class Level(object):
    ...
    def shift_str(self):
        ...
        return cobs.encode(bytes([self.data_pin]) + self.get_shift_string()) + b"\x00"
