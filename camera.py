...
class Camera:
    ...
    def detect_guess(self, player: int, image) -> tuple[int, int]:
...
player = 1
image = cv2.imread("images/boardtest3.png")
aruco_corners, ids, rejectedImgPoints = aruco.detectMarkers(
            image, aruco.getPredefinedDictionary(aruco.DICT_4X4_100)
        )
while True:
    ...
    # print(ids)
    # print(ids[0][0])
    # print(cam.detect_guess(1, "images/boardtest3.png"))
    # print(cam.detect_guess(2, "images/boardtest3.png"))
